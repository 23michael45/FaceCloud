...
public:
	...
	aiMatrix4x4 GetaiMatrix4x4()
	{
		aiMatrix4x4 AssimpMatrix;
		AssimpMatrix.a1 = m[0][0]; AssimpMatrix.a2 = m[0][1]; AssimpMatrix.a3 = m[0][2]; AssimpMatrix.a4 = m[0][3];
		AssimpMatrix.b1 = m[1][0]; AssimpMatrix.b2 = m[1][1]; AssimpMatrix.b3 = m[1][2]; AssimpMatrix.b4 = m[1][3];
		AssimpMatrix.c1 = m[2][0]; AssimpMatrix.c2 = m[2][1]; AssimpMatrix.c3 = m[1][2]; AssimpMatrix.c4 = m[2][3];
		AssimpMatrix.d1 = m[3][0]; AssimpMatrix.d2 = m[3][1]; AssimpMatrix.d3 = m[3][2]; AssimpMatrix.d4 = m[3][3];
		return AssimpMatrix;
	}
