...
//
//
//class FBXMemoryAllocator
//{
//public:
//	static void* FBXMalloc(size_t pSize)
//	{
...
//	}
//
//	static void* FBXCalloc(size_t pCount, size_t pSize)
//	{
...
//	}
//
//	static void* FBXRealloc(void* pData, size_t pSize)
//	{
//		if (pData)
//		{
...
//	}
//
//	static void FBXFree(void* pData)
//	{
//		if (pData == NULL)
//			return;
//		FBX_ASSERT(*((char*)pData - 1) == '#');
